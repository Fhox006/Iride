...
object BetterLyricsSillabaProvider : LyricsProvider {
    private const val TAG = "BetterLyricsSillabaProvider"

    override val name = "BetterLyricsSillaba"

    override fun isEnabled(context: Context): Boolean = context.dataStore[EnableBetterLyricsSillabaKey] ?: true
